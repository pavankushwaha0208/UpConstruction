...
<body>
  ...
  <div class="breadcrumbs d-flex align-items-center vh-100 bgimgservice"
     style="background-image: url('https://bageshwardhamofficial.com/assets/img/banner/contactus-banner.webp');">
    </div>
    <!-- ======= Contact Section ======= -->
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>Our Address</h3>
              <p>श्री बागेश्वर धाम ग्राम गड़ास्ट गंज जिला छतरपुर म.प्र.पिन - 471005</p>
            </div>
          </div><!-- End Info Item -->
